...
string gameExplainfunc(string read)
{
	cout << "Welcome user..." << endl;
	cout << "This is a spooky halloween game." << endl;
	cout << "Your goal is to make the right decisions to survive..." << endl;
	cout << "If not you will die! HAHAH" << endl;
	cout << "So do you think you can survive??" << endl;
	string hi = "SPOOKY HALLOWEEN";

	return hi;
}

//Gets users name function and returns name 
...
//Main story function that controls the different outcomes based on user option
